...
const TEMPLATES = [
    ...
    { id:'minimalista',label:'Minimalista',cardBg:'#ffffff', textColor:'#111827', subtitleColor:'#4b5563', detailColor:'#6b7280', dividerColor:'#e5e7eb', decoChar:'◆', thumbnailBg:'#f3f4f6', borderTop:'8px solid #770981' },
